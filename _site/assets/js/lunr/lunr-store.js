var store = [{
        ...
        "excerpt":"오늘은 파이썬에 대하여 알아보겠습니다.  Python 은 배우기 쉽습니다 !!!   이런글씨도 사용이 가능해요! 네이버로 이동!   _posts   Jekyll also offers powerful support for code snippets:  print(\"python 을 배워보아요!\")   print(\"한솔블로그에 오신것을 환영합니다. !!!\") def print_hi(name)   puts \"Hi, #{name}\" end print_hi('Tom') #=&gt; prints 'Hi, Tom' to STDOUT.   Check out the Jekyll docs for more info on how to get the most out of Jekyll. File all bugs/feature requests at Jekyll’s GitHub repo. If you have questions, you can ask them on Jekyll Talk.   ","categories": ["Python"],
        "tags": ["update","update","연습"],
        "url": "http://localhost:4000/python/welcome/",
